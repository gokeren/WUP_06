...
## Now with more data (less variables)
...
According to this graph above, more Black people oppose capital punishment than they favor it. White and other races favor capital punishment more percentage wise.
...
colPerc(table2)
```
This table reaffirms our percentages, 68% of the white group are in favor, 46% in the Black group and 55% in the Other group. 44% of the Other group, 54% of those in the Black group and 32% of the White group oppose capital punishment.
...
Because we used more data, the Fisher XY test was able to show us that the different test groups are different from each other. The White and Black groups are different, as well as the White and Other, in addition to the Black and Other groups.
