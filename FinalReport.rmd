...
This data illustrates that The Black group has equal percentage of people favor or oppose capital punishment. It also shows that the white and other group favor capital punishment at almost an equal percentage.
...
This table reaffirms what was mentioned in the previous graph, that the Black group had almost equal percentages for favor and oppose(49.55% vs 50.45%). It also shows that in the White and Other group, there was almost an identical amount percentage-wise of people who favor capital punishment(68.23% vs 68.75%) as well as oppose(31.77% and 31.25%).
...
```
 ...
 The Fisher test shows us that the Black and the Other group are indeed different. It also shows us that the White and the Black group are different. It does not show any more differences between the other and white groups.
